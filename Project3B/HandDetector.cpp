...
void HandDetector::DetectContours(cv::Mat& frame, cv::Mat& result_hsv, cv::Mat& result_masked, std::vector<std::vector<cv::Point>>& conts)
{
	// create mask
	...
	cv::findContours(result_masked, conts, cv::RETR_LIST, cv::CHAIN_APPROX_NONE);
